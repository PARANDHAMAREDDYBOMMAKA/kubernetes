    ...
    <div class="w-full max-w-md">
      ...
      <div class="card-base animate-fade-in overflow-hidden">
        ...
        >
          ...
          <span class="ml-2 text-xs text-slate-500">useradd.sh</span>
        </div>

        <div class="p-8">
          <div class="mb-6">
            <p class="text-xs text-slate-500">
              <span class="text-brand-400">➜</span> provision your account
            </p>
            <h1 class="mt-1 text-lg font-semibold text-slate-100">
              create account<span class="animate-blink text-brand-400">▊</span>
            </h1>
          </div>
